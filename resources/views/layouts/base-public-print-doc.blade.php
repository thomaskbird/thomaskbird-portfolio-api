...
header("content-disposition: attachment;filename=". date('Y-m-d') ."-thomas-bird-resume.doc");
...
<title>Thomas K Bird | Print Resume</title>
...
<body data-spy="scroll" data-target="#scrollSpy-nav" data-offset="70" id="print-template">

<div class="print-viewable-area">
    @yield('content')
</div>
