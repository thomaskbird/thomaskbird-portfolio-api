...
<title>Thomas K Bird | {{ $title }}</title>
...
<body data-spy="scroll" data-target="#scrollSpy-nav" data-offset="70">

@include('structure.header-public')

@yield('content')

@include('structure.footer-public')
